...
CRUMBS = {
    ...
    "redevelopment-desk.html": ["업무분야", "재건축·재개발", "정비사업 동향"],
    "registry.html": ["단체등기"],
...
CRUMB_PARENT = {
    ...
    "redevelopment-desk.html": "redevelopment.html",
    "registry-detail.html": "registry.html",
...
#  기업법무 · 민사·형사 · 하자소송 · 재건축·재개발 · 가사·상속·이혼 · 단체등기
#  사이트 전체(상단 메뉴 · 메인 · 업무분야 페이지)와 같은 차례로 둔다.
SERVICES = [
    "기업법무", "법인등기",
    "민사소송", "부동산소송", "형사변호",
    "하자소송",
...
def org_node():
    ...
    return {
        ...
        # 법인 대표번호는 서초 본사 02-537-0123. 등기센터 1899-4252 는 동탄 지점 항목에 둔다.
        "telephone": "+82-2-537-0123",
        "foundingDate": "2020",
        "priceRange": "상담 후 협의",
        "areaServed": [
